...
class Navigator:
    ...
    def update_button_states(self):
        ...
        if self.indices:
            ...
            self.con.config(state = "normal" if self.parser2 and self.index != con_index else "disabled")
            self.div.config(state = "normal" if self.parser2 and self.index != div_index else "disabled")
